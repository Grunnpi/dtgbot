...
local list_commands = {
    ["list"] = { handler = list_module.handler, description = "list - list devices, either all or specific type" },
    ["dump"] = { handler = list_module.handler, description = "dump - list all information about devices, either all or specific type" }
}
